...
import { Shield, Lock, Mail, User as UserIcon, ArrowRight, Loader2, AlertCircle } from 'lucide-react';
      ...
      >
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 13, color: '#8C8981', lineHeight: 1.5 }}>
            Establish an isolated workspace for your threat intelligence and investigations.
          </p>
        </div>
